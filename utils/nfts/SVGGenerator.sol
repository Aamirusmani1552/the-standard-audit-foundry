...
import "utils/nfts/DefGenerator.sol";
import "utils/nfts/NFTUtils.sol";
...
contract SVGGenerator {
    ...
    function mapCollateralForSVG(
        ISmartVault.Asset[] memory _collateral
    ) private pure returns (CollateralForSVG memory) {
        ...
        for (uint256 i = 0; i < _collateral.length; i++) {
            ...
            if (asset.amount > 0) {
                ...
                uint256 textYPosition = TABLE_INITIAL_Y +
                    currentRow *
                    TABLE_ROW_HEIGHT +
                    paddingTop;
                displayText = string(
                    abi.encodePacked(
                        ...
                        (TABLE_INITIAL_X + xShift + paddingLeftSymbol)
                            .toString(),
                        " ",
                        ...
                        "</text>",
                        "<text class='cls-8' transform='translate(",
                        (TABLE_INITIAL_X + xShift + paddingLeftAmount)
                            .toString(),
                        " ",
                        textYPosition.toString(),
                        ")'>",
    ...
    ) private pure returns (string memory mappedRows) {
        mappedRows = "";
    ...
    function collateralDebtPecentage(
        ISmartVault.Status memory _vaultStatus
    ) private pure returns (string memory) {
        return
            _vaultStatus.minted == 0
                ? "N/A"
                : string(
                    abi.encodePacked(
                        NFTUtils.toDecimalString(
                            (HUNDRED_PC * _vaultStatus.totalCollateralValue) /
                                _vaultStatus.minted,
                            3
                        ),
                        "%"
    ...
    function generateSvg(
        ...
        CollateralForSVG memory collateral = mapCollateralForSVG(
            _vaultStatus.collateral
        );
        return
            string(
                abi.encodePacked(
                    ...
                    "<text class='cls-5' transform='translate(1715.63 426.33)'><tspan x='0' y='0'>EUROs SmartVault #",
                    _tokenId.toString(),
                    "</tspan></text>",
                    ...
                    "<text class='cls-7' transform='translate(2191.03 719.41)'><tspan x='0' y='0'>",
                    NFTUtils.toDecimalString(
                        _vaultStatus.totalCollateralValue,
                        18
                    ),
                    " EUROs</tspan></text>",
                    "</g>",
                    ...
                    "<text class='cls-7' transform='translate(2191.03 822.75)'><tspan x='0' y='0'>",
                    ...
                    "<text class='cls-7' transform='translate(2191.03 924.1)'><tspan x='0' y='0'>",
                    ...
                    "<text class='cls-5' transform='translate(1715.63 1220.22)'><tspan x='0' y='0'>",
                    NFTUtils.toDecimalString(
                        _vaultStatus.totalCollateralValue - _vaultStatus.minted,
                        18
                    ),
                    " EUROs</tspan></text>",
                    "</g>",
