...
import "utils/nfts/SVGGenerator.sol";
...
contract NFTMetadataGenerator is INFTMetadataGenerator {
    ...
    function mapCollateralForJSON(
        ISmartVault.Asset[] memory _collateral
    ) private pure returns (string memory collateralTraits) {
        collateralTraits = "";
                    ...
                    Base64.encode(
                        abi.encodePacked(
                            ...
                            NFTUtils.toDecimalString(
                                _vaultStatus.maxMintable,
                                18
                            ),
                            '"},',
                            '{"trait_type": "Collateral Value in EUROs", "display_type": "number", "value": ',
                            NFTUtils.toDecimalString(
